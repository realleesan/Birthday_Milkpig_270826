...
export const HERO_DATA = {
  ...
  dateEventDisplay: '25.08.2026',
  ageTitle: 'Happy 27th Birthday & Our Special Date',
  ...
  audioUrl: 'https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=romantic-piano-wedding-love-116248.mp3', // Romantic acoustic track URL
  audioTitle: 'Romantic Birthday Melody',
};

export const COUNTDOWN_TARGET = '2026-08-25T17:00:00+07:00'; // 5:00 PM on Aug 25, 2026
...
export const ITINERARY_DATA: ItineraryItem[] = [
  ...
  },
  {
    ...
    description: 'Thưởng thức món ăn yêu thích dưới ánh nến lung linh, nâng ly chúc mừng tuổi 27 thật rực rỡ.',
...
export const LETTER_DATA = {
  ...
  paragraphs: [
    'Chúc mừng sinh nhật tuổi 27 của em! Thời gian trôi qua thật nhanh, nhưng từng khoảnh khắc được đồng hành cùng em đều là những ký ức vô giá.',
    'Tuổi mới, chúc em luôn giữ trọn nụ cười rạng rỡ, bình an trong tâm hồn và luôn gặt hái được thật nhiều thành công trong công việc và cuộc sống.',
    'Dù cho phía trước có như thế nào, hãy luôn nhớ rằng luôn có một người sẵn sàng lắng nghe, chia sẻ và đồng hành cùng em trên mọi chặng đường.',
    'Hãy sẵn sàng cho cuộc hẹn lãng mạn ngày 25/8 này nhé! 💖',
  ],
